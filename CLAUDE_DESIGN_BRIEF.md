...
> Document complet pour Claude Design (claude.ai). 16 images jointes.
...
| **10** | `10_PROCESS-step1-cree.jpg` | 🔍 **POSTER (référence visuelle)** | **GIF** déjà dans repo : `/public/process/step-1.gif` | Méthode étape 1 — câble le `.gif` existant avec `unoptimized={true}` |
| **11** | `11_PROCESS-step2-genere.jpg` | 🔍 **POSTER (référence visuelle)** | **MP4** déjà dans repo : `/public/process/step-2.mp4` | Méthode étape 2 — câble le `.mp4` avec `<video>` |
| **12** | `12_PROCESS-step3-monetise.jpg` | 🔍 **POSTER (référence visuelle)** | **GIF** déjà dans repo : `/public/process/step-3.gif` | Méthode étape 3 — câble le `.gif` existant avec `unoptimized={true}` |
| **13** | `13_REEL-storytelling.jpg` | 🔍 **POSTER (référence visuelle)** | déjà dans repo : `/public/reels/revo-crash.mov` | Reel slot 01 STORYTELLING |
| **14** | `14_REEL-ugc.jpg` | 🔍 **POSTER (référence visuelle)** | déjà dans repo : `/public/reels/ugc-nikon.mp4` | Reel slot 02 UGC |
| **15** | `15_REEL-client-ready.jpg` | 🔍 **POSTER (référence visuelle)** | déjà dans repo : `/public/reels/client-creative.mp4` | Reel slot 03 CLIENT READY |
| **16** | `16_REEL-ads.jpg` | 🔍 **POSTER (référence visuelle)** | déjà dans repo : `/public/reels/ads.mp4` | Reel slot 04 ADS |

### Règles d'usage des images jointes

**Images #01 à #09 = ASSETS À UTILISER DIRECTEMENT** dans le code (sauve les originaux `.png` dans `/public/` aux paths indiqués).

**Images #10 à #16 = POSTERS DE RÉFÉRENCE** :
- Ce sont des frames extraites des vidéos pour que tu visualises leur contenu
- ❌ NE PAS les utiliser comme assets dans le code
- ✅ Câble les paths `.mp4` / `.mov` / `.gif` existants dans le repo
...
**Posters de référence** : #10, #11, #12 (pour visualiser le contenu des médias)
**Assets à câbler** (déjà dans le repo) :
- `/process/step-1.gif`
- `/process/step-2.mp4`
- `/process/step-3.gif`
...
**Posters de référence** : #13, #14, #15, #16
**Assets à câbler** (déjà dans le repo) :
